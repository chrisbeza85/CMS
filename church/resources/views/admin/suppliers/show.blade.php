...
<head>
    ...
    <meta name="description" content="Supplier Details - Church Inventory">
...
<body>
    <div class="details-container">
        <div class="header-section">
            ...
            <div class="form-title">Supplier Details</div>
        </div>
        ...
        <div class="button-container">
            <a href="{{ route('suppliers.edit', $supplier->id) }}" class="details-btn btn-warning">
                <i class="fa fa-edit"></i>&nbsp; Edit
            </a>
            <a href="{{ route('admin.show_suppliers') }}" class="details-btn btn-primary">
