    ...
    <footer class="footer2">
        <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted4 d-block text-center text-sm-left d-sm-inline-block">
                <i class="fa-solid fa-user"></i>&nbsp;Donors List
            </span>
        </div>

        <div class="d-flex justify-content-start mt-2 mb-2">
            <a href="{{ route('donors.create') }}" class="btn btn-primary btn-sm rounded-circle" title="Add New Donor" style="width: 30px; height: 30px; display: inline-flex; align-items: center; justify-content: center;">
        ...
        <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted3 d-block text-center text-sm-left d-sm-inline-block">
                <i class="fa-solid fa-circle-info"></i>&nbsp;Total Donors:
                <span class="badge badge-info">{{ $donors->count() }}</span>
            </span>
        </div>

        <div class="search-container mb-3">
            <input type="text" id="search-input" class="form-control" placeholder="Search Donors" onkeyup="searchTable()">
        </div>
    </footer>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('donors.show', $donor->id) }}" class="btn btn-success btn-sm">
                                <i class="fa-solid fa-eye"></i> View
                            </a>
                        </td>
                        <td>
                            <a href="{{ route('donors.edit', $donor->id) }}" class="btn btn-warning btn-sm">
