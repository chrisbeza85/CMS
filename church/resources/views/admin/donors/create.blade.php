...
<head>
    ...
    <meta name="description" content="Church Manager - Add Donor" />
...
<body>
    <div class="form-container">
        ...
        <form action="{{ route('donors.store') }}" method="POST" autocomplete="on">
            @csrf
            ...
            <div class="input-row">
                ...
                <div class="input-group">
                    <input id="phone_no" name="phone_no" type="number" class="input" required autocomplete="phone_no" />
                    <label for="phone_no" class="placeholder">Phone</label>
                </div>
            </div>

            <!-- Center the buttons in a container -->
            <div class="button-container">
                <button type="submit" class="submitbtn btn-primary"><i class="fa fa-user-plus"></i>&nbsp;&nbsp;Save</button>
