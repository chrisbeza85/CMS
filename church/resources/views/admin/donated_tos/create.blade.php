...
<head>
    ...
    <meta name="description" content="Church Manager - Add DonatedTo">
...
<body>
    <div class="form-container">
        ...
        <h2 class="form-title">Add Reciever Details</h2>

        <form action="{{ route('donated_tos.store') }}" method="POST" autocomplete="on">
            @csrf
            ...
            <div class="input-row">
                ...
                <div class="input-group">
                    <input id="phone" name="phone" type="number" class="input" required />
                    <label for="phone" class="placeholder">Phone Number</label>
                </div>
            </div>

            <div class="button-container">
                <button type="submit" class="submitbtn btn-primary"><i class="fa fa-save"></i>&nbsp;&nbsp;Save</button>
                <a href="{{ route('admin.show_recipients') }}" class="submitbtn btn-secondary"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Back</a>
            </div>
        </form>
    </div>
