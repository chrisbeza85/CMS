    ...
    <footer class="footer2">
        <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted4 d-block text-center text-sm-left d-sm-inline-block">
                <i class="fa-solid fa-user"></i>&nbsp;Recipients List
            </span>
        </div>

        <div class="d-flex justify-content-start mt-2 mb-2">
            <a href="{{ route('donated_tos.create') }}" class="btn btn-primary btn-sm rounded-circle" title="Add Receiver" style="width: 30px; height: 30px; display: inline-flex; align-items: center; justify-content: center;">
        ...
        <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted3 d-block text-center text-sm-left d-sm-inline-block">
                <i class="fa-solid fa-circle-info"></i>&nbsp;Total Recipients:
                <span class="badge badge-info">{{ $donatedTos->count() }}</span>
            </span>
        </div>

        <div class="search-container mb-3">
            <input type="text" id="search-input" class="form-control" placeholder="Search Receivers" onkeyup="searchTable()">
        </div>
    </footer>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('donated_tos.show', $donatedTo->id) }}" class="btn btn-success btn-sm">
                                <i class="fa-solid fa-eye"></i> View
                            </a>
                        </td>
                        <td>
                            <a href="{{ route('donated_tos.edit', $donatedTo->id) }}" class="btn btn-warning btn-sm">
