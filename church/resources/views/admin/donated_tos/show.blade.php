<!-- resources/views/donated_tos/show.blade.php -->
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <meta name="description" content="Receiver Details - Church Inventory">
...
<body>
    <div class="details-container">
        <div class="header-section">
            ...
            <div class="form-title">Receiver Details</div>
        </div>

        <div class="details-row">
            <div class="details-item">
                <dt>Name</dt>
                <dd>{{ $donatedTo->name }}</dd>
            </div>
            <div class="details-item">
                <dt>Address</dt>
                <dd>{{ $donatedTo->address }}</dd>
            </div>
            <div class="details-item">
                <dt>Email</dt>
                <dd>{{ $donatedTo->email }}</dd>
            </div>
            <div class="details-item">
                <dt>Phone</dt>
                <dd>{{ $donatedTo->phone }}</dd>
            </div>
        </div>

        <div class="button-container">
            <a href="{{ route('donated_tos.edit', $donatedTo->id) }}" class="details-btn btn-warning">
                <i class="fa fa-edit"></i>&nbsp; Edit
            </a>
            <a href="{{ route('admin.show_recipients') }}" class="details-btn btn-primary">
