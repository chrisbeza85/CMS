...
<head>
    ...
    <meta name="description" content="Customer Details - Church Inventory">
...
<body>
    <div class="details-container">
        ...
        <div class="button-container">
            <a href="{{ route('customers.edit', $customer->id) }}" class="details-btn btn-warning">
                <i class="fa fa-edit"></i>&nbsp; Edit
            </a>
            <a href="{{ route('admin.show_customers') }}" class="details-btn btn-primary">
